$(function(){
    ...
    //header의 검색버튼을 클릭하면, .search-area 영역이 나타남
    ...
    //.input-area 의 input에 포커스가 이동하면 .input-area의 테두리 진하게 하기
    ...
    $(".family").mouseenter(function(){
        $(this).find("a span").css("transform", "rotateX(180deg)");
        $(this).find(".sub").slideDown();
    });
    
    
    $(".family").mouseleave(function(){
        $(this).find("a span").css("transform", "rotateX(0deg)");
